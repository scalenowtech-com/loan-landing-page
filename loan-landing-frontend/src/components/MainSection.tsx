...
import { CheckCircle2, User, Phone, MapPin, IndianRupee, BarChart } from "lucide-react";
    ...
    <section className="bg-[url('/bg.jpg')] bg-cover bg-center py-20">
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between px-6">
        ...
        <div className="max-w-xl pl-6 lg:pl-12 text-white">
          <p className="text-red-400 font-semibold underline">Instant Loan Approval</p>
          <h1 className="text-5xl font-bold leading-tight mt-2">
            Get Emergency Loan <br /> in <span className="text-red-500">30 Minutes</span>
          </h1>
          <p className="mt-4 text-lg text-gray-200">
            Quick, secure, and hassle-free loans for all your urgent financial needs.
            No lengthy paperwork, instant approval.
          </p>
          <div className="mt-6 flex space-x-4">
            ...
            <a href="tel:9266328731" className="border border-white px-6 py-3 rounded-full">
              Call: 6289867688
            </a>
          </div>
        </div>
    ...
    >
      ...
      <option>Not Sure</option>
            ...
            <p className="text-xs text-gray-500 text-center mt-2">
              By proceeding, you agree to our <span className="underline">Terms & Conditions</span> and <span className="underline">Privacy Policy</span>
            </p>
          </form>
        </div>
      </div>
