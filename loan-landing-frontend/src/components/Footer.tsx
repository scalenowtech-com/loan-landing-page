  ...
  return (
    <footer className="bg-gray-900 text-gray-300 py-10">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <p className="mt-2 text-sm text-gray-400">
            Your trusted partner for instant financial solutions. Quick, secure,
            and hassle-free loans.
          </p>
          <p className="mt-3 text-sm text-gray-400">📞 Call: 9266328731</p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-base">
            ...
            <li><a href="#" className="text-gray-400 hover:text-white">Grievance Cell</a></li>
          </ul>
        </div>
      </div>
      ...
      <div className="border-t border-gray-700 mt-8 pt-4 text-center text-base text-gray-400">
        © 2025 LoanInNeed. All rights reserved. | 
        A Unit of Sashi Enterprises Ltd.
      </div>
    </footer>
  );
}
